...
CMD ["sh", "-c", "echo \"window.__ENV__ = { VITE_API_URL: '$VITE_API_URL', VITE_KEYCLOAK_URL: '$VITE_KEYCLOAK_URL', VITE_KEYCLOAK_REALM: '$VITE_KEYCLOAK_REALM', VITE_KEYCLOAK_CLIENT_ID: '$VITE_KEYCLOAK_CLIENT_ID', VITE_PUBLIC_ACCOUNT_URL: '$VITE_PUBLIC_ACCOUNT_URL' };\" > /usr/share/nginx/html/config.js && exec nginx -g 'daemon off;'"]
